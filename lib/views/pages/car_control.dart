...
class _CarControlState extends State<CarControl> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      appBar: new AppBar(
        ...
        centerTitle: true,
        title: new Text('车门控制', style: Style.appBarTitleStyle,),
  ...
  Widget buildStartButton() {
    if (_isOn == true) {
      carOnOrOff = AssetImage("assets/car_control/car_on.png");
      onMessage = "Car is turned Off !";
      gifColor = Colors.red;
    } else {
      carOnOrOff = AssetImage("assets/car_control/car_off.png");
      onMessage = "Car is turned On !";
    ...
    return GestureDetector(
      onTap: () {
        setState(() {
          _isOn = !_isOn;
          buildSnackBar(onMessage, 'assets/car_control/power.gif', gifColor);
        });
      },
  ...
  Widget buildBackground() {
    if (_isLocked == true) {
      doorLockedOrUnlocked = AssetImage("assets/car_control/door_locked.png");
      lockOrUnlockImage = AssetImage("assets/car_control/lock.png");
      lockMessgae = "Door is UnLocked !";
      lockStatus = "Locked";
      ...
      lockOrUnlockImage = AssetImage("assets/car_control/unlock.png");
      lockMessgae = "Door is Locked !";
      lockStatus = "Unlocked";
      lockOrUnlockColor = LinearGradient(
        begin: FractionalOffset.topCenter,
        end: FractionalOffset.bottomCenter,
      ...
      child: SwipeButton(
        ...
        onChanged: (result) {
          if (result == SwipePosition.SwipeLeft) {
            setState(() {
              _isLocked = true;
              buildSnackBar(lockMessgae,'assets/car_control/lock.gif', Colors.red);
            });
          } else {
            setState(() {
              _isLocked = false;
              buildSnackBar(lockMessgae,'assets/car_control/lock.gif', Colors.green );
            });
          }
